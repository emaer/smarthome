...
public class OpenHABPreferencesCopyActivity extends PreferenceActivity {
	@Override
	...
	private void showAlertDialog(String alertMessage) {
		AlertDialog.Builder builder = new AlertDialog.Builder(OpenHABPreferencesCopyActivity.this);
